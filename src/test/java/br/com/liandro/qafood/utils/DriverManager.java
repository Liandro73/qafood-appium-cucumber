package br.com.liandro.qafood.utils;

import br.com.liandro.qafood.utils.enuns.Platform;
...
public class DriverManager {
    ...
    protected final static int LONG_TIMEOUT = 15;
    ...
    public static final String projectName = "QAFood";
    public static final String projectVersion = "1.0.0";
    public static final String sessionName = "Food Delivery App";
    ...
    public static void startDriver() {
        ...
        switch (platform) {
            case ANDROID:
                app = new File(classpathRoot, "/src/test/resources/apps/qafood.apk");
                ...
                break;
            case IOS:
                app = new File(classpathRoot, "/src/test/resources/apps/qafood.app");
                ...
                break;
            case DEVICEFARM_ANDROID:
                capabilities.setCapability("app", "bs://4e4adc5432078b2dc8b40aeff4a7b33b56810de5");
